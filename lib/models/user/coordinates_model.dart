...
class Address {
  ...
  Address({required this.coordinates, required this.addressLine, required this.countryName, required this.countryCode, required this.featureName, required this.postalCode, required this.adminArea, required this.subAdminArea, required this.locality, required this.subLocality, required this.thoroughfare, required this.subThoroughfare});
